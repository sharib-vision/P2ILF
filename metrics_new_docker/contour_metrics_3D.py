...
def get_args():
    ...
    parser.add_argument("--ModelRef", type=str, default="/Users/sharib/Documents/docker_evaluation/evaluationCodes/3D_metrics/testx/patient4_3D-liver-model.obj", help="Original 3D model - GT reference model")
    parser.add_argument("--ridgeLigamentLandmarks_3D_GT", type=str, default="/Users/sharib/Documents/docker_evaluation/evaluationCodes/3D_metrics/testx/patient4_3_3D-contours_GT.json", help="2D and 3D contours")
    parser.add_argument("--ridgeLigamentLandmarks_3D_eval", type=str, default="/Users/sharib/Documents/docker_evaluation/evaluationCodes/3D_metrics/testx/patient4_3_3D-contours_pred.json", help="2D and 3D contours")
